...
CREATE TABLE TON_KHO (
    ...
    Ma_Cua_Hang INT,
    Ma_Bien_The INT,
    FOREIGN KEY (Ma_Cua_Hang) REFERENCES CUA_HANG(Ma_Cua_Hang) ON DELETE CASCADE,
    FOREIGN KEY (Ma_Bien_The) REFERENCES BIEN_THE_SAN_PHAM(Ma_Bien_The) ON DELETE CASCADE
);
...
CREATE TABLE KHACH_HANG (
    ...
    Ngay_Sinh DATE,
    Hang_The VARCHAR(50) DEFAULT 'Moi',
...
CREATE TABLE DON_HANG (
    ...
    Trang_Thai VARCHAR(100) DEFAULT 'Cho xu ly',
    Ma_Khach_Hang INT,
    ...
    FOREIGN KEY (Ma_Cua_Hang) REFERENCES CUA_HANG(Ma_Cua_Hang) ON DELETE SET NULL
);
